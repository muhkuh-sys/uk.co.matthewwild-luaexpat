...
# Get all artifacts.
FILELIST=`lxc exec ${CONTAINER} -- bash -c 'find "/tmp/work" -path "/tmp/work/build/uk.co.matthewwild-luaexpat-lua*/targets/jonchki/repository/uk/co/matthewwild/luaexpat/*" -type f'`
echo ${FILELIST}
